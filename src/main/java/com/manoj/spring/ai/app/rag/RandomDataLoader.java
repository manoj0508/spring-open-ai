...
public class RandomDataLoader {
    ...
    @PostConstruct
    public void loadSentenceInVectorDB(){
        List<String> sentanceList = List.of("Java is used for building scalable enterprise applications.",
        ...
        List<Document> documentList = sentanceList.stream().map(Document::new).collect(Collectors.toList());
